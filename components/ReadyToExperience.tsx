...
interface ImageCardProps {
  ...
  return (
    ...
    >
        <h1 className={`lg:w-1/2 mx-auto text-center text-primary lg:text-[40px] text-[24px] font-[700] leading-[30px] lg:leading-[50px] pt-[81px] ${headingName}`}>{name}</h1>
        <p className={`lg:w-2/3 w-full mx-auto text-center text-primary text-[16px] font-[400] leading-[24px] pt-[16px]${descName}`}>{desc}</p>
