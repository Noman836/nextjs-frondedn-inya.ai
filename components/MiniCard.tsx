...
const MiniCard: React.FC<CardProps> = ({
  title,
  description,
  className = "border border-boxBorderColor rounded-[12px] xl:w-[350px] lg:w-[350px] md:w-[350px] w-full ",
    ...
    <main className={className}>
      <div className="pl-[32px] py-[32px] flex flex-col gap-[30px] items-stretch ">
        <div className="">
          ...
          <p className={`text-secondary lg:w-[100%] w-full font-[400] leading-[24px] text-[16px] ${descclasssName}`}>
            {description}
          </p>
        </div>
        <div className="">
